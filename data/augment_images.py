...
IMAGE_DIR = '/home/mwilkers1/Documents/Projects/IMPACT-EdgeAI-Mars_/data/mars_images/'
TRAIN_SET_FILE = 'labels/train-set-v2.1.txt'
...
augmentations = RandomTransforms([
    ...
    0.5,  # Probability for RandomHorizontalFlip
    0.5,  # Probability for RandomVerticalFlip
    0.5,  # Probability for RandomRotation
    0.5,  # Probability for ColorJitter
    0.5,  # Probability for RandomAffine
    1.0,  # Probability for RandomResizedCrop (always apply this one)
    0.1   # Probability for RandomGrayscale
])
